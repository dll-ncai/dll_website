 ...
 * @since 1.0
 */
class Creativ_Business_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'creativ_business';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				...
				'name'          => sprintf( __( 'Footer Widget %d', 'creativ-business' ), $i ),
...
// Initialize.
$creativ_business_footer_widgets = new Creativ_Business_Footer_Widgets();
