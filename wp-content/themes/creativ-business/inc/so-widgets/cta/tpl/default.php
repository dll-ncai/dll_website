<div id="call-to-action" class="relative">
    ...
    <div class="container">
        ...
        <div class="buttons">
            ...
            <?php if( !empty($instance['buttonTwo_title']) ): ?>
                <?php if( !empty( $instance['buttonTwo_url'] ) ) echo '<a href="' . sow_esc_url( $instance['buttonTwo_url'] ) . '" class="btn btn-default">'; ?>
                <?php echo esc_attr( $instance['buttonTwo_title'] ) ?>
                <?php if( !empty( $instance['buttonTwo_url'] ) ) echo '</a>'; ?>
            <?php endif; ?>
        </div><!-- .buttons -->
    </div><!--.container -->
</div><!-- #call-to-action -->